...
def pcl_callback(pcl_msg):
    ...
    ros_cluster_objects = pcl_to_ros(cloud_objects)
    ros_cluster_table = pcl_to_ros(cloud_table)


    # TODO: Publish ROS messages
    pcl_cloud_pub.publish(ros_cluster_cloud)
    pcl_objects_pub.publish(ros_cluster_objects)
    pcl_table_pub.publish(ros_cluster_table)
